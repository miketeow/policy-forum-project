## Roadmap
- [x] Data Lifecycle (Edit / Soft Delete): Right now, if a user makes a typo in a comment or posts something inappropriate, it's there forever. You need basic lifecycle management.
- [x] Data Bounding (Pagination & Sorting): This is critical. You cannot serve infinite arrays of JSON to your Next.js frontend or your future LLM.
